...
* Wordpress 4.9
    * `4.9.8-php7.2-apache` `4.9.8-apache` `4.9.8-php7.2` `4.9.8` `4.9-php7.2-apache` `4.9-apache` `4.9-php7.2` `4.9` `4-php7.2-apache` `4-apache` `4-php7.2` `4` `php7.2-apache` `apache` `php7.2` `latest`
    * `4.9.8-php7.2-fpm` `4.9.8-fpm` `4.9-php7.2-fpm` `4.9-fpm` `4-php7.2-fpm` `4-fpm` `php7.2-fpm` `fpm`
    * `4.9.8-php7.1-apache` `4.9.8-php7.1` `4.9-php7.1-apache` `4.9-php7.1` `4-php7.1-apache` `4-php7.1` `php7.1-apache` `php7.1`
    * `4.9.8-php7.1-fpm` `4.9-php7.1-fpm` `4-php7.1-fpm` `php7.1-fpm`
    * `4.9.8-php7.0-apache` `4.9.8-php7.0` `4.9-php7.0-apache` `4.9-php7.0` `4-php7.0-apache` `4-php7.0` `php7.0-apache` `php7.0`
    * `4.9.8-php7.0-fpm` `4.9-php7.0-fpm` `4-php7.0-fpm` `php7.0-fpm`
