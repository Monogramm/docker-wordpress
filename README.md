...
Tags:
-   `images/5.8/php7.4-apache/Dockerfile`: 5.8-apache apache 5.8 latest <!--+tags-->
-   `images/5.8/php7.4-fpm/Dockerfile`: 5.8-fpm fpm <!--+tags-->
-   `images/5.8/php7.4-fpm-alpine/Dockerfile`: 5.8-fpm-alpine fpm-alpine <!--+tags-->
-   `images/5.7/php7.4-apache/Dockerfile`: 5.7-apache 5.7 <!--+tags-->
-   `images/5.7/php7.4-fpm/Dockerfile`: 5.7-fpm <!--+tags-->
-   `images/5.7/php7.4-fpm-alpine/Dockerfile`: 5.7-fpm-alpine <!--+tags-->
-   `images/5.6/php7.4-apache/Dockerfile`: 5.6-apache 5.6 <!--+tags-->
-   `images/5.6/php7.4-fpm/Dockerfile`: 5.6-fpm <!--+tags-->
-   `images/5.6/php7.4-fpm-alpine/Dockerfile`: 5.6-fpm-alpine <!--+tags-->
-   `images/5.5/php7.4-apache/Dockerfile`: 5.5-apache 5.5 <!--+tags-->
-   `images/5.5/php7.4-fpm/Dockerfile`: 5.5-fpm <!--+tags-->
-   `images/5.5/php7.4-fpm-alpine/Dockerfile`: 5.5-fpm-alpine <!--+tags-->
